---
description: Run a review through Codex, Gemini, or Droid.
argument-hint: "[--engine <codex|gemini|droid>] [--model <id>] [--effort none|minimal|low|medium|high|xhigh] [--scope auto|working-tree|branch] [--base <ref>] [--wait|--background]"
